...
public class PemeriksaanGigiObject {
    ...
    public By getScanQRButton() {return By.xpath("/html/body/div/div/div/div[1]/div/div/div[2]/form/div[5]/button[1]");}
    public By getPeriksaButton() {return By.xpath("/html/body/div/div/div/div[1]/div/div/div[2]/form/div[5]/button[3]");}
}
